    ...
    <div className="space-y-6">
      ...
      <div className="bg-gradient-to-r from-blue-50 to-green-50 border border-blue-200 rounded-lg p-6">
        <div className="flex items-center space-x-4">
          ...
          <div className="flex-1">
            <h3 className="text-xl font-bold text-gray-900">{salary.employeeName}</h3>
            <p className="text-gray-600">{salary.position} - {salary.department}</p>
            <p className="text-sm text-gray-500">
              Période: {monthNames[salary.paymentMonth]} {salary.paymentYear}
            </p>
          </div>
          <div className="text-right">
            <p className="text-3xl font-bold text-green-600">{salary.netSalary.toLocaleString()} Ar</p>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-3">
            <div className="flex justify-between items-center py-2 border-b border-gray-100">
              ...
              <span className="font-bold text-gray-900">{salary.baseSalary.toLocaleString()} Ar</span>
            </div>
            
            {salary.allowances.transport && salary.allowances.transport > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                <span className="text-gray-600">Indemnité transport:</span>
                <span className="font-medium text-green-600">+{salary.allowances.transport.toLocaleString()} Ar</span>
              </div>
            )}
            ...
            {salary.allowances.housing && salary.allowances.housing > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium text-green-600">+{salary.allowances.housing.toLocaleString()} Ar</span>
              </div>
            )}
            ...
            {salary.allowances.meal && salary.allowances.meal > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium text-green-600">+{salary.allowances.meal.toLocaleString()} Ar</span>
              </div>
            )}
            ...
            {salary.allowances.performance && salary.allowances.performance > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium text-green-600">+{salary.allowances.performance.toLocaleString()} Ar</span>
              </div>
            )}
            ...
            {salary.allowances.other && salary.allowances.other > 0 && (
              <div className="flex justify-between items-center py-2 border-b border-gray-100">
                ...
                <span className="font-medium text-green-600">+{salary.allowances.other.toLocaleString()} Ar</span>
              </div>
            )}
            
            <div className="flex justify-between items-center py-3 bg-green-50 border border-green-200 rounded-lg px-3 mt-3">
              <span className="font-bold text-green-800">SALAIRE BRUT TOTAL:</span>
              <span className="text-xl font-bold text-green-600">{salary.totalGross.toLocaleString()} Ar</span>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white border border-gray-200 rounded-lg p-6">
          ...
          <div className="space-y-4">
            ...
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              <h5 className="font-medium text-red-800 mb-2">Cotisations Sociales</h5>
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
              <h5 className="font-medium text-purple-800 mb-2">Impôt IRSA</h5>
              <div className="flex justify-between">
            ...
            <div className="bg-gray-100 border border-gray-300 rounded-lg p-4">
              <div className="flex justify-between items-center">
                ...
                <span className="text-xl font-bold text-red-600">-{salary.totalDeductions.toLocaleString()} Ar</span>
              </div>
            </div>
            ...
            <div className="bg-green-100 border-2 border-green-400 rounded-lg p-4">
              <div className="text-center">
                <h5 className="font-bold text-green-800 mb-2">SALAIRE NET À PAYER</h5>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <h4 className="font-medium text-gray-900 mb-3">Informations Administratives</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
        ...
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-4">
          <h4 className="font-medium text-gray-900 mb-3">Charges Patronales</h4>
          <div className="space-y-2 text-sm">
            <div className="flex justify-between">
      ...
      {salary.notes && (
        <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
          ...
          <p className="text-blue-700 text-sm">{salary.notes}</p>
        </div>
      )}
