...
import { Eye, Edit, Trash2, Users, DollarSign, Calendar, Building, Calculator, CheckCircle, AlertTriangle, Clock } from 'lucide-react';
    ...
    <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
      <div className="bg-gray-50 px-6 py-4 border-b border-gray-200">
        <div className="flex items-center justify-between">
          <h2 className="text-lg font-bold text-gray-900">Liste des Calculs de Salaires</h2>
          <span className="text-sm text-gray-600">{salaries.length} enregistrement(s)</span>
        </div>
      </div>
      ...
      {salaries.length === 0 ? (
        <div className="text-center py-12">
          ...
          <h3 className="text-lg font-medium text-gray-900 mb-2">Aucun calcul de salaire</h3>
          <p className="text-gray-500 mb-6">Commencez par créer votre premier calcul de salaire.</p>
        </div>
      ) : (
        <div className="overflow-x-auto">
          <table className="w-full">
            <thead className="bg-gray-50 border-b border-gray-200">
              <tr>
                <th className="text-left py-4 px-6 font-medium text-gray-900">Employé</th>
                <th className="text-left py-4 px-6 font-medium text-gray-900">Période</th>
                <th className="text-left py-4 px-6 font-medium text-gray-900">Salaire Brut</th>
                <th className="text-left py-4 px-6 font-medium text-gray-900">Déductions</th>
                <th className="text-left py-4 px-6 font-medium text-gray-900">Salaire Net</th>
