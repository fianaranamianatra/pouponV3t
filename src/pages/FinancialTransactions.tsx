    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div>
          ...
          <p className="text-gray-600">Suivi des flux financiers de l'établissement</p>
        </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        <div className="bg-white rounded-lg p-4 border border-gray-100">
          <div className="flex items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-green-600">{totalEncaissements.toLocaleString()} Ar</p>
            </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-100">
          <div className="flex items-center">
            <div>
              ...
              <p className="text-2xl font-bold text-red-600">{totalDecaissements.toLocaleString()} Ar</p>
            </div>
            <TrendingDown className="w-8 h-8 text-red-600 ml-auto" />
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg p-4 border border-gray-100">
          <div className="flex items-center">
            ...
            <DollarSign className={`w-8 h-8 ml-auto ${solde >= 0 ? 'text-blue-600' : 'text-red-600'}`} />
          </div>
        </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden">
        {transactions.length === 0 ? (
          <div className="text-center py-12">
            ...
            <h3 className="text-lg font-medium text-gray-900 mb-2">Aucune transaction enregistrée</h3>
            <p className="text-gray-500 mb-6">Commencez par enregistrer votre première transaction financière.</p>
            <button
        ...
        {selectedTransaction && (
          <div className="space-y-6">
            <div className="flex items-center space-x-4">
              ...
              <div>
                <h3 className="text-xl font-bold text-gray-900">{selectedTransaction.reference || 'Transaction'}</h3>
                <p className="text-gray-600">{selectedTransaction.description}</p>
                <p className="text-sm text-gray-500">{selectedTransaction.category}</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div>
                <h4 className="font-medium text-gray-900 mb-2">Informations de suivi</h4>
                <div className="space-y-2 text-sm">
